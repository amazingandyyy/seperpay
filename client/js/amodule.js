...
angular
    ...
    .config(function($stateProvider, $urlRouterProvider, $authProvider) {
        ...
        $stateProvider
            ...
            .state(dashboard_plan_details_edit)
...
let dashboard_plan_details_edit = {
    name: 'dashboard_plan_details_edit',
    url: '/details/:planId/edit',
    parent: 'dashboard_plan',
    views: {
        dashboard_child_section: {
            templateUrl: '/html/dashboard/dashboard_plan_details_edit.html',
            controller: 'dashboardPlanCtrl'
        }
    }
}
